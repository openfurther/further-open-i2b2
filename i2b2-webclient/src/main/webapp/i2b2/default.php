...
<!-- load i2b2 framework -->
<script type="text/javascript" src="js-i2b2/i2b2_loader.js?v=1"></script>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-25477672-2']);
		...
		<div class="bd">
			...
			<div style="border: 1px solid rgb(171, 173, 179); margin-left: 40px; width: 505px; padding: 4px">
                ...
                <div id="countDatasources" style="padding: 2px">
						...
						if ($ini['demo']) {
							echo 
							'<div class="further_datasource_name" style="margin-left:10px"><input type="checkbox" class="chkQueryType" name="countQueryType" value="OMOPv2">Schultz Cancer Repository (OMOP v2 data source)</div>
	                        <div class="further_datasource_name" style="margin-left:10px"><input type="checkbox" class="chkQueryType" name="countQueryType" value="OpenMRSv1_9">Schultz Healthcare Systems (OpenMRS v1.9 data source)</div>';
						} else {
							echo 
                ...
                <div id="dataDatasources" style="display:none; padding: 2px;">
						...
						if ($ini['demo']) {
							echo 
							'<div class="further_datasource_name" style="margin-left:10px"><input type="checkbox" class="chkQueryType" name="dataQueryType" value="OMOPv2">Schultz Cancer Repository (OMOP v2 data source)</div>
	                        <div class="further_datasource_name" style="margin-left:10px"><input type="checkbox" class="chkQueryType" name="dataQueryType" value="OpenMRSv1_9">Schultz Healthcare Systems (OpenMRS v1.9 data source)</div>';
						} else {
							echo 
