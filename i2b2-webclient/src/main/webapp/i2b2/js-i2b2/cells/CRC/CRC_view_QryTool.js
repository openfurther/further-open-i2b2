...
// ================================================================================================== //
            ...
            i2b2.sdx.Master.AttachType('assocResultBox', 'PRS', op_trgt);
            ...
            i2b2.sdx.Master.setHandlerCustom('assocResultBox', 'PRS', 'DropHandler', (function(sdxData) {
            	sdxData = sdxData[0];	// only interested in first record
            	i2b2.CRC.ctrlr.QT.doAssociatedResultsDrop(sdxData);
            }));
