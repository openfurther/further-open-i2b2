/*******************************************************************************
 * Source File: I2b2FurtherDataSourceResult.java
 ******************************************************************************/
...
/**
 * Transfer object containing a FURTHeR query result obtained from a single data source.
 * <p>
 * -----------------------------------------------------------------------------------<br>
...
public final class I2b2FurtherDataSourceResult
{
	// ========================= FIELDS ====================================
	 ...
	 * JAXB-required.
	 */
	public I2b2FurtherDataSourceResult()
	{
		super();
	}
	 ...
	 *            count
	 */
	public I2b2FurtherDataSourceResult(final String name, final long count)
	{
		super();
		this.name = name;
		this.count = count;
