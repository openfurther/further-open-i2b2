...
public class GlobalDataServiceImpl implements PortletServiceProvider, GlobalDataService {	
	/**
	 * Name of user columns in all database tables whose name starts with "PM_".
	 * Must match the database column name declared in RoleData.hbm.xml, UserData.hbm.xml.
	 * Must also match the script "svn:/further/tools/vm-i2b2/i2b2user_default_schema.sql",
	 * if the i2b2 JBoss gridsphere webapp "default"'s Hibernate schema is generated
	 * manually. 
	 */
	private static final String USER_COLUMN_NAME = "user1";
	...
	public List getUserData(String project, String user) {
		return queryDB(UserData.class.getName(),  "where project='" + project + "' and " + USER_COLUMN_NAME + "='" + user + "'");
	}
	...
	public List getRoleData(String project, String user) {
		return queryDB(RoleData.class.getName(),  "where project='" + project + "' and " + USER_COLUMN_NAME + "='" + user + "'");
	}
